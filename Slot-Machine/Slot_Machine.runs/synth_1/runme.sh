...
HD_PWD='C:/Users/victo/OneDrive/Documentos/5 ao/TOC/project_5Avanzada/project_5Avanzada.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tragaperras.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tragaperras.tcl
