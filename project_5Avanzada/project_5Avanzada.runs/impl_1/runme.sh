...
HD_PWD='C:/Users/victo/OneDrive/Documentos/5 ao/TOC/project_5Avanzada/project_5Avanzada.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tragaperras.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tragaperras.tcl -notrace
